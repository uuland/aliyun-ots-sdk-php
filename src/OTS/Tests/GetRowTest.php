...
class GetRowTest extends SDKTestBase {
    ...
    public function testGetRowWithColumnFilterToGet() {
    	...
    	$putdata2 = array(
    			"table_name" => $usedTables[0],
    			"condition" => RowExistenceExpectationConst::IGNORE,
    			"primary_key" => array("PK1" => "a2", "PK2" => 2, "PK3" => "a22", "PK4" => 22),
    			"attribute_columns" => array("attr1" => 2, "attr2" => "aaa", "attr3" => "tass", "attr4" => 22)
    	);
    	...
    	$querybody = array(
    			"table_name" => $usedTables[0],
    			"primary_key" => array("PK1" => "a2", "PK2" => 2, "PK3" => "a22", "PK4" => 22),
    			"columns_to_get" => array("PK1", "PK2", "PK3", "PK4"),
    			"column_filter" => array(
    ...
    public function testGetRowWithColumnFilterToGet2() {
    	...
    	$putdata2 = array(
    			"table_name" => $usedTables[0],
    			"condition" => RowExistenceExpectationConst::IGNORE,
    			"primary_key" => array("PK1" => "aa2", "PK2" => 2, "PK3" => "aa22", "PK4" => 22),
    			"attribute_columns" => array("attr1" => 2, "attr2" => "aaa", "attr3" => "tass", "attr4" => 22)
    	);
    	$this->otsClient->putRow($putdata1);
    	$this->otsClient->putRow($putdata2);
